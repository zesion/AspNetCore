...
namespace Microsoft.AspNetCore.SignalR
{
    ...
    {
        private readonly NoAllocConcurrentDictionary<string, HubConnectionContext> _connections =
            new NoAllocConcurrentDictionary<string, HubConnectionContext>(StringComparer.Ordinal);
        ...
        public readonly struct Enumerator
        {
            ...
            {
                _enumerator = hubConnectionList._connections.GetFastEnumerator();
            }
        ...
        private class NoAllocConcurrentDictionary<TKey, TValue> : IDictionary<TKey, TValue>, IDictionary, IReadOnlyDictionary<TKey, TValue>
        {
            /// <summary>
            ...
            /// </summary>
            public NoAllocConcurrentDictionary() : this(DefaultConcurrencyLevel, DefaultCapacity, true, null) { }
            ...
            /// 0.</exception>
            public NoAllocConcurrentDictionary(int concurrencyLevel, int capacity) : this(concurrencyLevel, capacity, false, null) { }
            ...
            public NoAllocConcurrentDictionary(IEnumerable<KeyValuePair<TKey, TValue>> collection) : this(collection, null) { }
            ...
            public NoAllocConcurrentDictionary(IEqualityComparer<TKey> comparer) : this(DefaultConcurrencyLevel, DefaultCapacity, true, comparer) { }
            ...
            /// <exception cref="T:System.ArgumentNullException"><paramref name="collection"/> is a null reference
            /// (Nothing in Visual Basic).</exception>
            public NoAllocConcurrentDictionary(IEnumerable<KeyValuePair<TKey, TValue>> collection, IEqualityComparer<TKey> comparer)
                : this(comparer)
            {
            ...
            public NoAllocConcurrentDictionary(
            ...
            /// </exception>
            public NoAllocConcurrentDictionary(int concurrencyLevel, int capacity, IEqualityComparer<TKey> comparer)
                : this(concurrencyLevel, capacity, false, comparer)
            {
            }

            internal NoAllocConcurrentDictionary(int concurrencyLevel, int capacity, bool growLockArray, IEqualityComparer<TKey> comparer)
            {
            ...
            public Enumerator GetFastEnumerator() => new Enumerator(this);
            ...
            public struct Enumerator : IEnumerator<KeyValuePair<TKey, TValue>>
            {
                ...
                public Enumerator(NoAllocConcurrentDictionary<TKey, TValue> dictionary)
                {
                    if (dictionary == null)
                    {
            ...
            {
                return ((NoAllocConcurrentDictionary<TKey, TValue>)this).GetEnumerator();
            }
            ...
            object IDictionary.this[object key]
            {
                ...
                set
                {
                    ...
                    ((NoAllocConcurrentDictionary<TKey, TValue>)this)[(TKey)key] = (TValue)value;
                }
            }
            ...
            private sealed class DictionaryEnumerator : IDictionaryEnumerator
            {
                ...
                internal DictionaryEnumerator(NoAllocConcurrentDictionary<TKey, TValue> dictionary)
                {
